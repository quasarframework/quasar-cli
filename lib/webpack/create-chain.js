...
module.exports = function (cfg, configName) {
  ...
  chain.resolve.extensions
    .merge([ `.${cfg.ctx.themeName}.js`, '.js', `.${cfg.ctx.themeName}.vue`, '.vue' ])
  ...
  chain.resolve.alias
    .merge({
      quasar: appPaths.resolve.app(`node_modules/quasar-framework/src/index.esm.js`),
      src: appPaths.srcDir,
      app: appPaths.appDir,
        ...
        .options({
          ...
          plugins: [
            [
              'transform-imports', {
                quasar: {
                  transform: appPaths.resolve.cli(`node_modules/quasar-framework/dist/babel-transforms/imports.${cfg.ctx.themeName}.js`),
                  preventFullImport: cfg.framework.all !== true
                }
              }
            ]
          ]
            ...
            vendors: {
              ...
              test (module) {
                ...
                return (
                  ...
                  /node_modules|quasar\//.test(module.context) &&
                  // and not a CSS file
