...
function launchPreview(defaultConfig, userConfig) {
  /*
   * Initialize Server
   */
...
gulp.task('preview', ['build'], function() {
  launchPreview(gulp._.config.preview || {}, gulp._.config.app.preview || {});
});

gulp.task('rpreview', ['build'], function() {
  launchPreview(gulp._.config.rpreview || {}, gulp._.config.app.rpreview || {});
});
