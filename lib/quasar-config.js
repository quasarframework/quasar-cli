...
class QuasarConfig {
  ...
  compile () {
    ...
    // remove Meta since it's useless on Cordova
    if (this.ctx.mode.cordova && cfg.__meta && cfg.framework.plugins) {
      cfg.framework.plugins.splice(cfg.framework.plugins.indexOf('Meta'), 1)
      cfg.__meta = false
    }
