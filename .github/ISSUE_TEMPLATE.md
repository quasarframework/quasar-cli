...
- Check if the issue is reproducible with the latest stable version of Quasar CLI. If you are using a pre-release, please indicate the specific version you are using.
